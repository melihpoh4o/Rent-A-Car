    ...
    <div class="row justify-content-center p-5">
        ...
        <form class="p-5 mt-3 mb-3 col-sm-6 col-md-8 col-lg-6 col-xl-3 text-light rounded" method="post" style="background-color: #1D334A">
            ...
            <div class="form-group mb-3">
                <input type="email" class="form-control" name="email" placeholder="E-mailadres" aria-describedby="emailHelp">
            </div>
            ...
            <button  type="submit" name="login" class="btn mb-3  mt-3 bg-light">INLOGGEN</button>
